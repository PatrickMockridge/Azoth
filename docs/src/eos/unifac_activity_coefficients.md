...
- NeqSim - https://github.com/equinor/neqsim - Apache-2.0. `ComponentGEUnifac`/`PhaseGEUnifac` are the port source; NeqSim 3.20.0's classic UNIFAC fails at runtime, so there is no differential oracle.
