<!-- Generated by tools/gen_docs.py from specs/models/eos/tu_flash.toml. Do not edit by hand. -->
...
| Name | Unit | Description |
|---|---|---|
| `P` | Pa | the pressure that satisfies the internal energy. This is the answer. |
...
| `residual` | dimensionless | `(U(P) - U_target) / |U_target|` at the answer, signed |
...
|---|---|---|
| `two_phase_round_trip` | components = ['methane', 'n-butane'], T = 300.0, U = -4179.034516413562, z = [0.6, 0.4] | P = 1000000.0, beta = 0.8356955 |
