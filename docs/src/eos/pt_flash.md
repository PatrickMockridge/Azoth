...
|---|---|---|
| `methane_and_butane_at_330_k_and_25_bar` | components = ['methane', 'n-butane'], T = 330.0, P = 2500000.0, z = [0.6, 0.4] | beta = 0.8420898401624567, x = [0.09509318456633194, 0.9049068154336675], y = [0.6946810092291505, 0.30531899077084956], k = [7.305266012461472, 0.337403791819745], ln_phi_liquid = [1.9811732937018562, -1.4952619193021057], ln_phi_vapour = [-0.007422165956260954, -0.40878704872658556], z_liquid = 0.09313667832529118, z_vapour = 0.8686440327919862, min_t_over_tc = 0.7762514113662025, iterations = 13 |
| `methane_propane_and_butane_at_350_k_and_50_bar` | components = ['methane', 'propane', 'n-butane'], T = 350.0, P = 5000000.0, z = [0.5, 0.3, 0.2] | beta = 0.9932447664006336, x = [0.16766845375171718, 0.3840765304065674, 0.44825501584171634], y = [0.5022602457151435, 0.2994281806234139, 0.19831157366144256], k = [2.9955560183007863, 0.7796055132721901, 0.44240792997945727], ln_phi_liquid = [1.1601969343698872, -0.7920367128976444, -1.629149032419563], ln_phi_vapour = [0.06306707120088248, -0.5430694734703525, -0.8136261284335301], z_liquid = 0.192412097980494, z_vapour = 0.69779773837306, min_t_over_tc = 0.8232969514490026, iterations = 22 |
| `a_subcooled_liquid_feed` | components = ['methane', 'n-butane'], T = 300.0, P = 3000000.0, z = [0.1, 0.9] | beta = -0.06999107083186745, x = [0.15058781722285508, 0.849412182777146], y = [0.8733631172947335, 0.1266368827052846], k = [5.799693052209147, 0.1490876694177453], ln_phi_liquid = [1.7021454595960943, -2.413688311483233], ln_phi_vapour = [-0.055659534521914564, -0.5104675507716051], z_liquid = 0.11032280379131874, z_vapour = 0.8875483816159516, min_t_over_tc = 0.7056831012420023, iterations = 12 |
