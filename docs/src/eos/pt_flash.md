...
| `water_methanol_cpa_at_356_k_and_1_bar` | components = ['water', 'methanol'], eos = srk, associating = True, T = 356.0, P = 100000.0, z = [0.6, 0.4] | beta = 0.208383589004737, x = [0.674266566871552, 0.325733433128448], y = [0.317873017714004, 0.682126982285996], k = [0.4714352354611679, 2.094126401893144], ln_phi_liquid = [-0.789379766771299, 0.668790784130641], ln_phi_vapour = [-0.0374062219152301, -0.070345690341699], z_liquid = 0.000876327166634292, z_vapour = 0.941152554938007, min_t_over_tc = 0.5499768268190948, iterations = 12 |
