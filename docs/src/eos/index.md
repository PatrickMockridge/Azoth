...
| [`eos.chapman_enskog_diffusivity`](./chapman_enskog_diffusivity.md) | $D_{AB} = \frac{0.00266\,T^{1.5}}{P\,\sqrt{M_{AB}}\,\sigma_{AB}^{2}\,\Omega_D\!\left(\frac{T}{\varepsilon_{AB}}\right)},\qquad \Omega_D = \frac{A}{t^{B}} + \frac{C}{e^{Dt}} + \frac{E}{e^{Ft}} + \frac{G}{e^{Ht}}$ | Chapman, S.; Enskog, D. (1917) |
...
| [`eos.fuller_schettler_giddings_diffusivity`](./fuller_schettler_giddings_diffusivity.md) | $D_{AB} = 1.013\times10^{-3}\,\frac{T^{1.75}\sqrt{\frac{1}{M_A}+\frac{1}{M_B}}}{P\left(V_A^{1/3}+V_B^{1/3}\right)^{2}}$ | Fuller, E. N.; Schettler, P. D.; Giddings, J. C. (1966) |
...
| [`eos.hybrid_eos_ge_flash`](./hybrid_eos_ge_flash.md) | `fixed_topology_fraction_newton` | NeqSim master `SystemEosGE`'s hybrid route |
