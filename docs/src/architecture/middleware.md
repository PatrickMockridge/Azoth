...
| a form per unit op (ports + parameters) | the spec exists and now says which parameters a form must mark required (`Param::required`, held to the model spec); nothing yet turns it into a form |
