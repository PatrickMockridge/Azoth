...
```
check_manifest: OK (37 vendored file(s), 1497 column(s), 1470 carried of which 1050 read, 0 not-vendored entr(ies))
  420  carried, nothing reads it yet
...
**The porting backlog is "carried, nothing reads it yet" — 420 columns — and it is
...
`not-ported` reason names the class that would close it — **414 columns carry it**, carried
