...
```
check_manifest: OK (37 vendored file(s), 1497 column(s), 1476 carried of which 1132 read, 0 not-vendored entr(ies))
  344  carried, nothing reads it yet
...
**The porting backlog is "carried, nothing reads it yet" — 344 columns — and it is
...
`not-ported` reason names the class that would close it — **303 columns carry it**, carried
