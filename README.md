...
- **A formal layer in Lean.** The dimension group is proved (`lean/Azoth/Dim.lean`); the
  37-unit vocabulary compiles into theorems (`lean/Azoth/Vocabulary.lean`).
...
The full catalog — 67 calculations and 114 models, each with its equation, source, valid
