...
//! ``chemeng._rust_bridge`` converts each one into the result dataclass the pure
...
use chemeng_core::CalcResult;
use chemeng_core::warning::{Warning, WarningCode};
use chemeng_hydraulics::results::{
...
/// was in.
#[pyclass(frozen, skip_from_py_object, module = "chemeng._core", name = "Qty")]
...
pub fn version() -> String {
    chemeng_core::VERSION.to_string()
}
