...
//! happens once, in Python, in `chemeng.hydraulics`, before the call crosses this
//! boundary.
//!
...
//! itself.
//!
//! The cost is that `chemeng._core` is not units-safe on its own. It is a private
//! module: the public API is `chemeng.hydraulics`, which is.

use chemeng_core::units::{
    DynamicViscosity, kilograms_per_cubic_meter, meters, meters_per_second, pascal_seconds,
};
use chemeng_hydraulics as hyd;
use pyo3::prelude::*;
