//! `chemeng._core` - the compiled core, exposed to Python.
//!
//! # What this module is and is not
//!
//! It is a numerical core with a private name. The public Python API is
//! `chemeng.hydraulics`, which decides whether to call this module or the pure
...
//!   See `hydraulics.rs`.
//! * **Exception classes are imported from `chemeng.core.errors`, not defined
...
fn _core(py: Python<'_>, m: &Bound<'_, PyModule>) -> PyResult<()> {
    m.add(
        "__doc__",
        "Compiled core for chemeng. Use chemeng.hydraulics instead.",
    )?;
