...
static CONDUCTION_PLANE_WALL_CHECKS: &[SpecCheck] = &[
    SpecCheck {
        ...
        check: RangeCheck {
            ...
            rationale: "Thermal conductivity is strictly positive for any real material. A zero or negative value is not a limiting case to warn about but a number that is wrong, and it would produce a heat flow in the wrong direction or none at all.",
        },
    },
    SpecCheck {
        on_input: true,
