...
use chemeng_core::units::{self, DynamicViscosity, Length, MassDensity, Velocity};
use chemeng_core::{ChemEngError, Result, Warning, WarningCode};
...
pub struct PipeResult {
    ...
    pub regime: chemeng_core::FlowRegime,
    /// Friction factor.
