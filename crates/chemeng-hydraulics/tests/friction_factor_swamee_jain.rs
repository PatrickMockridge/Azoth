...
use chemeng_core::{CalcResult, ChemEngError, WarningCode};
use chemeng_hydraulics::spec_gen::TestCase;
use chemeng_hydraulics::{friction_factor_swamee_jain, reynolds_number};

const CALC_ID: &str = "hydraulics.friction_factor_swamee_jain";

fn call(case: &TestCase) -> chemeng_hydraulics::SwameeJainResult {
