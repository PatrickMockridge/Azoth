...
use chemeng_core::{CalcResult, FlowRegime, Warning};
...
pub struct ReynoldsNumberResult {
    ...
    /// Caveats. Carries [`chemeng_core::WarningCode::TransitionalFlow`] when the
...
pub struct KFactorsResult {
    ...
    /// Caveats. Carries [`chemeng_core::WarningCode::EstimatedData`] while the
...
pub struct DarcyWeisbachResult {
    ...
    /// Caveats. Carries [`chemeng_core::WarningCode::RangeCheckSkipped`] when
...
mod tests {
    ...
    fn darcy_result_distinguishes_unchecked_from_checked() {
        use chemeng_core::units::pascals;
