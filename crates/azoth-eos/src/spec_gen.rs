...
//!   - specs/calcs/eos/chapman_enskog_diffusivity.toml
...
//!   - specs/calcs/eos/fuller_schettler_giddings_diffusivity.toml
...
/// Registry entry for `eos.chapman_enskog_diffusivity`.
static CHAPMAN_ENSKOG_DIFFUSIVITY_CHECKS: &[SpecCheck] = &[
    SpecCheck {
        on_input: true,
        check: RangeCheck {
            quantity: "T",
...
static CHAPMAN_ENSKOG_DIFFUSIVITY_TESTS: &[TestCase] = &[
    TestCase {
        ...
        vectors: &[],
        matrices: &[],
        expected: &[("d", 2.1853611628506023e-05)],
        expected_vectors: &[],
        expected_strings: &[],
    },
    TestCase {
        ...
        vectors: &[],
        matrices: &[],
        expected: &[("d", 9.457085848059925e-07)],
        expected_vectors: &[],
        expected_strings: &[],
    },
    TestCase {
        ...
        vectors: &[],
        matrices: &[],
        expected: &[("d", 1.6228425436789486e-06)],
        expected_vectors: &[],
        expected_strings: &[],
    },
];

/// Registered spec for `eos.chapman_enskog_diffusivity`.
///
/// Public and addressable directly, so a calc can hold `&CHAPMAN_ENSKOG_DIFFUSIVITY_SPEC` with no
/// lookup and no failure path. A calc whose spec is missing is a build-time
/// invariant, not a runtime condition, and this shape makes it unrepresentable
/// rather than something to handle.
pub static CHAPMAN_ENSKOG_DIFFUSIVITY_SPEC: CalcSpec = CalcSpec {
    id: "eos.chapman_enskog_diffusivity",
    checks: CHAPMAN_ENSKOG_DIFFUSIVITY_CHECKS,
    solver: None,
    worked_example: TestCase {
        ...
        vectors: &[],
        matrices: &[],
        expected: &[("d", 3.555070057344887e-05)],
        expected_vectors: &[],
        expected_strings: &[],
    },
    tests: CHAPMAN_ENSKOG_DIFFUSIVITY_TESTS,
};
...
/// Registry entry for `eos.fuller_schettler_giddings_diffusivity`.
static FULLER_SCHETTLER_GIDDINGS_DIFFUSIVITY_CHECKS: &[SpecCheck] = &[
    SpecCheck {
        on_input: true,
        check: RangeCheck {
            quantity: "T",
    ...
    SpecCheck {
        ...
        check: RangeCheck {
            ...
            severity: Severity::Warning,
            code: WarningCode::OutOfValidRange,
            rationale: "`Diffusivity.T_MIN` and `T_MAX`: outside that band the class's own `enableTemperatureWarnings` says the correlation is not validated, and the port says the same thing in its own vocabulary rather than log-only.",
        },
    },
];

static FULLER_SCHETTLER_GIDDINGS_DIFFUSIVITY_TESTS: &[TestCase] = &[
    TestCase {
        id: "methane_nitrogen_is_the_measured_pair",
        kind: "reference",
        property: None,
        status: "active",
        skip_reason: None,
        ...
        vectors: &[],
        matrices: &[],
        expected: &[("d", 2.155058583907974e-05)],
        expected_vectors: &[],
        expected_strings: &[],
    },
    TestCase {
        id: "co2_nitrogen_second_measured_pair",
        kind: "reference",
        property: None,
        status: "active",
        skip_reason: None,
        ...
        vectors: &[],
        matrices: &[],
        expected: &[("d", 1.6244535413221675e-05)],
        expected_vectors: &[],
        expected_strings: &[],
    },
    TestCase {
        id: "the_pressure_scale_is_bar",
        kind: "reference",
        property: None,
        status: "active",
        skip_reason: None,
        ...
        vectors: &[],
        matrices: &[],
        expected: &[("d", 4.367226220289509e-06)],
        expected_vectors: &[],
        expected_strings: &[],
    },
    TestCase {
        id: "four_hundred_kelvin_scales_as_t_to_the_one_point_seven_five",
        kind: "reference",
        property: None,
        status: "active",
        skip_reason: None,
        ...
        vectors: &[],
        matrices: &[],
        expected: &[("d", 3.604152357783764e-05)],
        expected_vectors: &[],
        expected_strings: &[],
    },
    TestCase {
        id: "a_name_outside_the_special_table_takes_the_critical_volume_rung",
        kind: "reference",
        property: None,
        status: "active",
        skip_reason: None,
        ...
        vectors: &[],
        matrices: &[],
        expected: &[("d", 2.0851238582061954e-05)],
        expected_vectors: &[],
        expected_strings: &[],
    },
    TestCase {
        id: "the_rate_based_column_s_own_state",
        kind: "reference",
        property: None,
        status: "active",
        skip_reason: None,
        ...
        vectors: &[],
        matrices: &[],
        expected: &[("d", 3.922539294026516e-07)],
        expected_vectors: &[],
        expected_strings: &[],
    },
];

/// Registered spec for `eos.fuller_schettler_giddings_diffusivity`.
///
/// Public and addressable directly, so a calc can hold `&FULLER_SCHETTLER_GIDDINGS_DIFFUSIVITY_SPEC` with no
/// lookup and no failure path. A calc whose spec is missing is a build-time
/// invariant, not a runtime condition, and this shape makes it unrepresentable
/// rather than something to handle.
pub static FULLER_SCHETTLER_GIDDINGS_DIFFUSIVITY_SPEC: CalcSpec = CalcSpec {
    id: "eos.fuller_schettler_giddings_diffusivity",
    checks: FULLER_SCHETTLER_GIDDINGS_DIFFUSIVITY_CHECKS,
    solver: None,
    worked_example: TestCase {
        id: "methane_nitrogen_worked_example",
        kind: "worked_example",
        property: None,
        status: "active",
        skip_reason: None,
    ...
    tests: FULLER_SCHETTLER_GIDDINGS_DIFFUSIVITY_TESTS,
};
