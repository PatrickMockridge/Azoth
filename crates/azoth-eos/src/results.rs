...
impl CalcResult for HeliumPhaseResult {
    const CALC_ID: &'static str = "eos.helium_phase";
    const FIELDS: &'static [&'static str] =
        &["z_factor", "u", "h", "s", "cv", "cp", "g", "warnings"];
...
impl CalcResult for Co2PhaseResult {
    const CALC_ID: &'static str = "eos.co2_phase";
    const FIELDS: &'static [&'static str] =
        &["z_factor", "u", "h", "s", "cv", "cp", "g", "warnings"];
...
impl CalcResult for WaterPhaseResult {
    const CALC_ID: &'static str = "eos.water_phase";
    const FIELDS: &'static [&'static str] =
        &["z_factor", "u", "h", "s", "cv", "cp", "g", "warnings"];
...
#[derive(Debug, Clone, PartialEq)]
pub struct ArgonSolidPhaseResult {
    /// The compressibility factor `Z = P v/(R T)`.
    pub z_factor: f64,
    /// The internal energy.
    pub u: MolarEnergy,
...
impl CalcResult for ArgonSolidPhaseResult {
    const CALC_ID: &'static str = "eos.argon_solid_phase";
    const FIELDS: &'static [&'static str] =
        &["z_factor", "u", "h", "s", "cv", "cp", "g", "warnings"];
...
#[derive(Debug, Clone, PartialEq)]
pub struct ParahydrogenSolidPhaseResult {
    /// The compressibility factor `Z = P v/(R T)`.
    pub z_factor: f64,
    /// The internal energy.
    pub u: MolarEnergy,
...
impl CalcResult for ParahydrogenSolidPhaseResult {
    const CALC_ID: &'static str = "eos.parahydrogen_solid_phase";
    const FIELDS: &'static [&'static str] =
        &["z_factor", "u", "h", "s", "cv", "cp", "g", "warnings"];
...
pub struct VsFlashResult {
    ...
    /// Newton steps taken.
    pub iterations: u32,
    /// The larger of the relative volume and entropy residuals at the answer.
    pub residual: f64,
    /// Caveats, deduplicated.
    pub warnings: Vec<Warning>,
}

impl CalcResult for VsFlashResult {
    const CALC_ID: &'static str = "eos.vs_flash";
    const FIELDS: &'static [&'static str] = &[
        "P",
        "T",
        "beta",
...
impl CalcResult for VhFlashResult {
    const CALC_ID: &'static str = "eos.vh_flash";
    const FIELDS: &'static [&'static str] = &[
        "P",
        "T",
        "beta",
...
impl CalcResult for PvfFlashResult {
...
#[derive(Debug, Clone, PartialEq)]
pub struct PvRefluxFlashResult {
...
impl CalcResult for PvRefluxFlashResult {
...
impl CalcResult for GeNrtlPhaseResult {
    const CALC_ID: &'static str = "eos.ge_nrtl_phase";
...
#[derive(Debug, Clone, PartialEq)]
pub struct GeUnifacPhaseResult {
    /// The activity coefficient of each component.
    pub gamma: Vec<f64>,
    /// The natural logarithm of each activity coefficient.
    pub ln_gamma: Vec<f64>,
...
impl CalcResult for GeUnifacPhaseResult {
    const CALC_ID: &'static str = "eos.ge_unifac_phase";
    const FIELDS: &'static [&'static str] = &["gamma", "ln_gamma", "ln_phi", "p_sat", "warnings"];
...
#[derive(Debug, Clone, PartialEq)]
pub struct GeWilsonPhaseResult {
    /// The activity coefficient of each component.
    pub gamma: Vec<f64>,
    /// The natural logarithm of each activity coefficient.
    pub ln_gamma: Vec<f64>,
...
impl CalcResult for GeWilsonPhaseResult {
    const CALC_ID: &'static str = "eos.ge_wilson_phase";
    const FIELDS: &'static [&'static str] = &["gamma", "ln_gamma", "ln_phi", "p_sat", "warnings"];
...
#[derive(Debug, Clone, PartialEq)]
pub struct FurstElectrolytePhaseResult {
    /// The compressibility factor at the chosen root.
    pub z_factor: f64,
    /// The fugacity coefficients, as logarithms, one per component.
    pub ln_phi: Vec<f64>,
...
impl CalcResult for FurstElectrolytePhaseResult {
    const CALC_ID: &'static str = "eos.furst_electrolyte_phase";
...
#[derive(Debug, Clone, PartialEq)]
pub struct GeVanLaarAcidPhaseResult {
    /// The activity coefficient of each component.
    pub gamma: Vec<f64>,
    /// The natural logarithm of each activity coefficient.
    pub ln_gamma: Vec<f64>,
...
impl CalcResult for GeVanLaarAcidPhaseResult {
    const CALC_ID: &'static str = "eos.ge_van_laar_acid_phase";
    const FIELDS: &'static [&'static str] = &["gamma", "ln_gamma", "ln_phi", "p_sat", "warnings"];
...
#[derive(Debug, Clone, PartialEq)]
pub struct UnifacActivityCoefficientsResult {
    /// The natural logarithm of each activity coefficient.
    pub ln_gamma: Vec<f64>,
    /// The activity coefficient of each component.
    pub gamma: Vec<f64>,
...
impl CalcResult for UnifacActivityCoefficientsResult {
    const CALC_ID: &'static str = "eos.unifac_activity_coefficients";
    const FIELDS: &'static [&'static str] = &["ln_gamma", "gamma", "warnings"];
...
impl CalcResult for UnifacPsrkActivityCoefficientsResult {
    const CALC_ID: &'static str = "eos.unifac_psrk_activity_coefficients";
    const FIELDS: &'static [&'static str] = &["ln_gamma", "gamma", "warnings"];
...
#[derive(Debug, Clone, PartialEq)]
pub struct VanLaarAcidActivityCoefficientsResult {
    /// The natural logarithm of each activity coefficient.
    pub ln_gamma: Vec<f64>,
    /// The activity coefficient of each component.
    pub gamma: Vec<f64>,
...
impl CalcResult for VanLaarAcidActivityCoefficientsResult {
    const CALC_ID: &'static str = "eos.van_laar_acid_activity_coefficients";
    const FIELDS: &'static [&'static str] = &["ln_gamma", "gamma", "warnings"];
...
#[derive(Debug, Clone, PartialEq)]
pub struct WilsonActivityCoefficientsResult {
    /// The natural logarithm of each activity coefficient.
    pub ln_gamma: Vec<f64>,
    /// The activity coefficient of each component.
    pub gamma: Vec<f64>,
...
impl CalcResult for WilsonActivityCoefficientsResult {
    const CALC_ID: &'static str = "eos.wilson_activity_coefficients";
    const FIELDS: &'static [&'static str] = &["ln_gamma", "gamma", "warnings"];
...
#[derive(Debug, Clone, PartialEq)]
pub struct TwucoonParamAlphaResult {
    /// The temperature-dependent alpha function. Dimensionless.
    pub alpha: f64,
    /// Caveats.
    pub warnings: Vec<Warning>,
...
impl CalcResult for TwucoonParamAlphaResult {
    const CALC_ID: &'static str = "eos.twucoon_param_alpha";
    const FIELDS: &'static [&'static str] = &["alpha", "warnings"];
...
impl CalcResult for PrDaneshAlphaResult {
    const CALC_ID: &'static str = "eos.pr_danesh_alpha";
    const FIELDS: &'static [&'static str] = &["alpha", "warnings"];
...
#[derive(Debug, Clone, PartialEq)]
pub struct MatcopPrAlphaResult {
    /// The temperature-dependent alpha function. Dimensionless.
    pub alpha: f64,
    /// Caveats.
    pub warnings: Vec<Warning>,
...
impl CalcResult for MatcopPrAlphaResult {
    const CALC_ID: &'static str = "eos.matcop_pr_alpha";
    const FIELDS: &'static [&'static str] = &["alpha", "warnings"];
...
#[derive(Debug, Clone, PartialEq)]
pub struct MatcopPrumrAlphaResult {
    /// The temperature-dependent alpha function. Dimensionless.
    pub alpha: f64,
    /// Caveats.
    pub warnings: Vec<Warning>,
...
impl CalcResult for MatcopPrumrAlphaResult {
    const CALC_ID: &'static str = "eos.matcop_prumr_alpha";
    const FIELDS: &'static [&'static str] = &["alpha", "warnings"];
...
#[derive(Debug, Clone, PartialEq)]
pub struct Matcop5PrumrAlphaResult {
    /// The temperature-dependent alpha function. Dimensionless.
    pub alpha: f64,
    /// Caveats.
    pub warnings: Vec<Warning>,
...
impl CalcResult for Matcop5PrumrAlphaResult {
    const CALC_ID: &'static str = "eos.matcop5_prumr_alpha";
    const FIELDS: &'static [&'static str] = &["alpha", "warnings"];
...
#[derive(Debug, Clone, PartialEq)]
pub struct PrLeeKeslerAlphaResult {
    /// The temperature-dependent alpha function. Dimensionless.
    pub alpha: f64,
    /// Caveats.
    pub warnings: Vec<Warning>,
...
impl CalcResult for PrLeeKeslerAlphaResult {
    const CALC_ID: &'static str = "eos.pr_lee_kesler_alpha";
    const FIELDS: &'static [&'static str] = &["alpha", "warnings"];
...
impl CalcResult for SrkCpaPhaseResult {
    const CALC_ID: &'static str = "eos.srk_cpa_phase";
...
impl CalcResult for UmrCpaPhaseResult {
    const CALC_ID: &'static str = "eos.umr_cpa_phase";
    const FIELDS: &'static [&'static str] = &["z_factor", "ln_phi", "h_res", "s_res", "warnings"];
