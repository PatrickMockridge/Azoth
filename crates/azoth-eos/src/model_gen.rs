...
//!   - specs/models/eos/phase_transport.toml
...
static AQUEOUS_VISCOSITY_CHECKS: &[SpecCheck] = &[
    SpecCheck {
        on_input: true,
        check: RangeCheck {
            quantity: "T",
...
static AQUEOUS_VISCOSITY_CASES: &[TestCase] = &[
    TestCase {
        id: "water_at_300_k_and_1_bar",
        kind: "case",
        property: None,
        status: "active",
        skip_reason: None,
        ...
        vectors: &[("z", &[1.0])],
        matrices: &[],
        expected: &[("viscosity", 0.0008547585317553409)],
        expected_vectors: &[],
        expected_strings: &[],
    },
    TestCase {
        id: "water_at_300_k_and_5_bar",
        kind: "case",
        property: None,
        status: "active",
        skip_reason: None,
        tolerance: 1e-12,
        numbers: &[("T", 300.0), ("P", 500000.0)],
        flags: &[],
        lists: &[("components", &["water"])],
        strings: &[],
        vectors: &[("z", &[1.0])],
        matrices: &[],
        expected: &[("viscosity", 0.0008551044828231576)],
        expected_vectors: &[],
        expected_strings: &[],
    },
    TestCase {
        id: "water_through_the_temperature_range",
        kind: "case",
        property: None,
        status: "active",
        skip_reason: None,
        tolerance: 1e-12,
        numbers: &[("T", 280.0), ("P", 500000.0)],
        flags: &[],
        lists: &[("components", &["water"])],
        strings: &[],
        vectors: &[("z", &[1.0])],
        matrices: &[],
        expected: &[("viscosity", 0.001422878428248548)],
        expected_vectors: &[],
        expected_strings: &[],
    },
    TestCase {
        ...
        skip_reason: None,
        tolerance: 1e-12,
        numbers: &[("T", 320.0), ("P", 500000.0)],
        flags: &[],
        lists: &[("components", &["water"])],
        strings: &[],
        vectors: &[("z", &[1.0])],
        matrices: &[],
        expected: &[("viscosity", 0.0005725923588703773)],
        expected_vectors: &[],
        expected_strings: &[],
    },
    TestCase {
        ...
        skip_reason: None,
        tolerance: 1e-12,
        numbers: &[("T", 350.0), ("P", 500000.0)],
        flags: &[],
        lists: &[("components", &["water"])],
        strings: &[],
        vectors: &[("z", &[1.0])],
        matrices: &[],
        expected: &[("viscosity", 0.00036479710612851546)],
        expected_vectors: &[],
        expected_strings: &[],
    },
    TestCase {
        id: "methanol_at_300_k_and_5_bar",
        kind: "case",
        property: None,
        status: "active",
        skip_reason: None,
        ...
        numbers: &[("T", 300.0), ("P", 500000.0)],
        flags: &[],
        lists: &[("components", &["methanol"])],
        strings: &[],
        vectors: &[("z", &[1.0])],
        matrices: &[],
        expected: &[("viscosity", 0.0004955318590786208)],
        expected_vectors: &[],
        expected_strings: &[],
    },
    TestCase {
        id: "teg_at_300_k_and_5_bar",
        kind: "case",
        property: None,
        status: "active",
        skip_reason: None,
        ...
        numbers: &[("T", 300.0), ("P", 500000.0)],
        flags: &[],
        lists: &[("components", &["TEG"])],
        strings: &[],
        vectors: &[("z", &[1.0])],
        matrices: &[],
        expected: &[("viscosity", 0.03461914543810686)],
        expected_vectors: &[],
        expected_strings: &[],
    },
];

/// Registry entry for `eos.aqueous_viscosity`.
pub static AQUEOUS_VISCOSITY_SPEC: ModelSpec = ModelSpec {
    id: "eos.aqueous_viscosity",
    kind: "direct",
    algorithm: None,
    checks: AQUEOUS_VISCOSITY_CHECKS,
    cases: AQUEOUS_VISCOSITY_CASES,
};
...
static FREEZING_POINT_CASES: &[TestCase] = &[
    ...
    TestCase {
        id: "the_lng_feed_neqsims_own_test_builds",
        kind: "case",
        property: None,
        status: "active",
        skip_reason: None,
        ...
        lists: &[(
            "components",
            &["CO2", "nitrogen", "methane", "ethane", "propane"],
        )],
        strings: &[("solid", "CO2")],
        vectors: &[(
            "z",
        ...
        matrices: &[],
        expected: &[("temperature", 184.710072436643)],
        expected_vectors: &[],
        expected_strings: &[("component", "CO2")],
    },
];
...
static FURST_ELECTROLYTE_MOD2004_PHASE_CASES: &[TestCase] = &[
    TestCase {
        ...
        matrices: &[],
        expected: &[("z_factor", 0.009635856436241555)],
        expected_vectors: &[(
            "ln_phi",
            &[
                8.372595802264165,
    ...
    TestCase {
        ...
        matrices: &[],
        expected: &[("z_factor", 0.9832407607272112)],
        expected_vectors: &[(
            "ln_phi",
            &[
                -0.0168629980706277,
...
static HYDRATE_FORMATION_PRESSURE_CHECKS: &[SpecCheck] = &[
    ...
    SpecCheck {
        ...
        check: RangeCheck {
            ...
            severity: Severity::Error,
            code: WarningCode::OutOfValidRange,
            rationale: "an absolute pressure; the answer cannot be at or below zero",
        },
    },
];

static HYDRATE_FORMATION_PRESSURE_CASES: &[TestCase] = &[
    TestCase {
        ...
        matrices: &[],
        expected: &[("pressure", 4755816.196713141)],
        expected_vectors: &[],
    ...
    TestCase {
        ...
        matrices: &[],
        expected: &[("pressure", 2553765.013200787)],
        expected_vectors: &[],
        expected_strings: &[("structure", "structure_ii")],
    },
    TestCase {
        ...
        matrices: &[],
        expected: &[("pressure", 1408645.517847312)],
        expected_vectors: &[],
        expected_strings: &[("structure", "structure_ii")],
    },
];

static HYDRATE_FORMATION_PRESSURE_ALGORITHM: ModelAlgorithm = ModelAlgorithm {
    scheme: "hydrate_pressure_bisection",
    convergence: "absolute",
    tolerance: 1e-08,
    max_iterations: 60,
    bracket: Some(ModelBracket {
        scheme: "log_scan_pressure",
        lower: 10000.0,
        upper: 20000000.0,
        steps: 80,
    }),
    initialisation: Some("log_scan_for_sign_change"),
    initial_temperature: None,
    inner: None,
    fallback: None,
};

/// Registry entry for `eos.hydrate_formation_pressure`.
pub static HYDRATE_FORMATION_PRESSURE_SPEC: ModelSpec = ModelSpec {
    id: "eos.hydrate_formation_pressure",
    kind: "procedure",
    algorithm: Some(&HYDRATE_FORMATION_PRESSURE_ALGORITHM),
    checks: HYDRATE_FORMATION_PRESSURE_CHECKS,
    cases: HYDRATE_FORMATION_PRESSURE_CASES,
};
...
static PHASE_TRANSPORT_CHECKS: &[SpecCheck] = &[
    SpecCheck {
        on_input: true,
        check: RangeCheck {
            quantity: "T",
    ...
    SpecCheck {
        ...
        check: RangeCheck {
            ...
            severity: Severity::Error,
            code: WarningCode::OutOfValidRange,
            rationale: "a mole fraction cannot be negative, and NeqSim reads one without checking it",
        },
    },
];

static PHASE_TRANSPORT_CASES: &[TestCase] = &[
    TestCase {
        id: "methane_nitrogen_298k_1atm_gas",
        kind: "case",
        property: None,
        status: "active",
        skip_reason: None,
        tolerance: 0.0001,
        numbers: &[("T", 298.15), ("P", 101325.0)],
        flags: &[],
        lists: &[("components", &["methane", "nitrogen"])],
        strings: &[("phase", "gas")],
        vectors: &[("z", &[0.5, 0.5])],
        matrices: &[],
        expected: &[("mu", 1.4506127676908967e-05), ("k", 0.029958794899910723)],
        expected_vectors: &[],
        expected_strings: &[],
    },
    TestCase {
        id: "methane_co2_313k_50bar_gas",
        kind: "case",
        property: None,
        status: "active",
        skip_reason: None,
        ...
        vectors: &[("z", &[0.5, 0.5])],
        matrices: &[],
        expected: &[("mu", 1.6159655797683304e-05), ("k", 0.030071678065251736)],
        expected_vectors: &[],
        expected_strings: &[],
    },
    TestCase {
        id: "methane_nbutane_300k_20bar_gas",
        kind: "case",
        property: None,
        status: "active",
        skip_reason: None,
        tolerance: 0.0001,
        numbers: &[("T", 300.0), ("P", 2000000.0)],
        flags: &[],
        lists: &[("components", &["methane", "n-butane"])],
        strings: &[("phase", "gas")],
        vectors: &[("z", &[0.8356249351028912, 0.1643750648971088])],
        matrices: &[],
        expected: &[("mu", 1.1173254776369514e-05), ("k", 0.032654729853716064)],
        expected_vectors: &[],
        expected_strings: &[],
    },
    TestCase {
        id: "methane_nbutane_300k_20bar_oil",
        kind: "case",
        property: None,
        status: "active",
        skip_reason: None,
        ...
        lists: &[("components", &["methane", "n-butane"])],
        strings: &[("phase", "oil")],
        vectors: &[("z", &[0.09542082642782022, 0.9045791735721797])],
        matrices: &[],
        expected: &[("mu", 0.00013466360688772563), ("k", 0.09534463941597507)],
        expected_vectors: &[],
        expected_strings: &[],
    },
    TestCase {
        id: "co2_water_313k_50bar_gas",
        kind: "case",
        property: None,
        status: "active",
        skip_reason: None,
        ...
        numbers: &[("T", 313.15), ("P", 5000000.0)],
        flags: &[],
        lists: &[("components", &["CO2", "water"])],
        strings: &[("phase", "gas")],
        vectors: &[("z", &[0.9978562046113857, 0.002143795388614308])],
        matrices: &[],
        expected: &[("mu", 1.8462596972222117e-05), ("k", 0.024804749452710006)],
        expected_vectors: &[],
        expected_strings: &[],
    },
    TestCase {
        id: "co2_water_313k_50bar_aqueous",
        kind: "case",
        property: None,
        status: "active",
        skip_reason: None,
        ...
        flags: &[],
        lists: &[("components", &["CO2", "water"])],
        strings: &[("phase", "aqueous")],
        vectors: &[("z", &[0.0006691762234084198, 0.9993308237765915])],
        matrices: &[],
        expected: &[("mu", 0.0006526078179332641), ("k", 0.6344057039895419)],
        expected_vectors: &[],
        expected_strings: &[],
    },
];

/// Registry entry for `eos.phase_transport`.
pub static PHASE_TRANSPORT_SPEC: ModelSpec = ModelSpec {
    id: "eos.phase_transport",
    kind: "direct",
    algorithm: None,
    checks: PHASE_TRANSPORT_CHECKS,
    cases: PHASE_TRANSPORT_CASES,
};

static PITZER_PHASE_CHECKS: &[SpecCheck] = &[
    SpecCheck {
        on_input: true,
        check: RangeCheck {
            quantity: "P",
            ...
            severity: Severity::Error,
            code: WarningCode::OutOfValidRange,
            rationale: "an absolute pressure; the fugacity coefficient divides by it and zero or below is not a state",
        },
    },
    SpecCheck {
        on_input: true,
...
static PITZER_PHASE_CASES: &[TestCase] = &[
    TestCase {
        ...
        expected: &[
            ...
            ("osmotic_coefficient", 1.099026940549135),
            ("water_activity", 0.8608221912794107),
        ],
        expected_vectors: &[
            (
                "gamma",
                &[0.9782070355447849, 0.7652808165351391, 0.7652808165351391],
            ),
            (
                "ln_gamma",
                &[
            ...
            (
                "ln_phi",
                &[-3.4707151839323496, 27.36352827715267, 27.36352827715267],
            ),
            ("henry", &[0.0, 1000000000000.0, 1000000000000.0]),
            ("gamma_inf", &[1.0, 0.9999804068927719, 0.9999804068927719]),
            (
                "molality",
    ...
    TestCase {
        ...
        matrices: &[],
        expected: &[
            ("ionic_strength", 6.623268488380893),
        ...
        expected_vectors: &[
            ...
            (
                "henry",
                &[0.0, 1000000000000.0, 1000000000000.0, 1000000000000.0],
            ),
            (
                "gamma_inf",
                &[
    ...
    TestCase {
        ...
        expected: &[
            ("ionic_strength", 3.784724850503368),
            ("osmotic_coefficient", 0.8792926497311331),
            ("water_activity", 0.8870059903990346),
        ],
        expected_vectors: &[
            (
                "gamma",
                &[1.0079613527261757, 0.45645201676126573, 0.45645201676126573],
            ),
            (
                "ln_gamma",
                &[0.0079298283647304, -0.7842716956189597, -0.7842716956189597],
            ),
            (
                "ln_phi",
                &[-3.440751417002622, 26.846769013608764, 26.846769013608764],
            ),
            ("henry", &[0.0, 1000000000000.0, 1000000000000.0]),
            ("gamma_inf", &[1.0, 0.9999804068927719, 0.9999804068927719]),
            (
    ...
    TestCase {
        id: "carbon_dioxide_in_brine_at_10_bar",
        kind: "case",
        property: None,
        status: "active",
        skip_reason: None,
        ...
        numbers: &[("T", 298.15), ("P", 1000000.0)],
        flags: &[],
        lists: &[("components", &["CO2", "water", "Na+", "Cl-"])],
        strings: &[],
        vectors: &[(
            "x",
            &[
                0.008619500758516066,
                0.9569024962074196,
        ...
        matrices: &[],
        expected: &[
            ("ionic_strength", 1.0000233805466372),
            ("osmotic_coefficient", 0.9356267424413548),
            ("water_activity", 0.9668504783804639),
        ],
        expected_vectors: &[
            (
                "gamma",
            ...
            (
                "henry",
                &[51.65450928785164, 0.0, 1000000000000.0, 1000000000000.0],
            ),
            (
                "gamma_inf",
                &[1.0, 1.0, 0.9999804068927719, 0.9999804068927719],
            ),
            (
                "molality",
                &[
    ...
    TestCase {
        ...
        expected: &[
            ("ionic_strength", 1.0000233805466372),
            ("osmotic_coefficient", 0.9360977456136553),
            ("water_activity", 0.9668340704472524),
        ],
        expected_vectors: &[
            (
                "gamma",
            ...
            (
                "henry",
                &[1000000000000.0, 0.0, 1000000000000.0, 1000000000000.0],
            ),
            (
                "gamma_inf",
                &[1.0, 1.0, 0.9999804068927719, 0.9999804068927719],
    ...
    TestCase {
        id: "hydrogen_sulphide_in_water_at_one_atmosphere",
        kind: "case",
        property: None,
        status: "active",
        skip_reason: None,
        ...
        numbers: &[("T", 298.15), ("P", 101325.0)],
        flags: &[],
        lists: &[("components", &["H2S", "water"])],
        strings: &[],
        vectors: &[("x", &[0.000999000999000999, 0.999000999000999])],
        matrices: &[],
        expected: &[
            ("ionic_strength", 0.0),
            ("osmotic_coefficient", 1.0),
            ("water_activity", 0.999000999000999),
        ],
        expected_vectors: &[
            ("gamma", &[1.0, 1.0]),
            ("ln_gamma", &[0.0, 0.0]),
            ("ln_phi", &[22.352588957775026, -3.4618442318936333]),
            ("henry", &[93008543.19275573, 0.0]),
            ("gamma_inf", &[1.0, 1.0]),
            ("molality", &[0.055509297807382736, 55.50929780738274]),
        ],
        expected_strings: &[("dataset", "legacy")],
    },
    TestCase {
        id: "methane_in_water_at_one_atmosphere",
        kind: "case",
        property: None,
        status: "active",
        skip_reason: None,
        ...
        expected_vectors: &[
            ("gamma", &[1.0, 1.0]),
            ("ln_gamma", &[0.0, 0.0]),
            ("ln_phi", &[10.571392848178034, -3.4618442318936333]),
            ("henry", &[711.2370654308118, 0.0]),
            ("gamma_inf", &[1.0, 1.0]),
            ("molality", &[0.055509297807382736, 55.50929780738274]),
        ],
        expected_strings: &[("dataset", "legacy")],
    ...
    TestCase {
        id: "carbon_dioxide_in_water_at_one_atmosphere",
        kind: "case",
        property: None,
        status: "active",
        skip_reason: None,
        ...
        lists: &[("components", &["CO2", "water"])],
        strings: &[],
        vectors: &[("x", &[0.047619047619047616, 0.9523809523809523])],
        matrices: &[],
        expected: &[
            ("ionic_strength", 0.0),
            ("osmotic_coefficient", 1.0),
            ("water_activity", 0.9523809523809523),
        ],
        expected_vectors: &[
            ("gamma", &[1.0, 1.0]),
            ("ln_gamma", &[0.0, 0.0]),
            ("ln_phi", &[7.9967552088819165, -3.4618442318936333]),
            ("henry", &[51.65450928785164, 0.0]),
            ("gamma_inf", &[1.0, 1.0]),
            ("molality", &[2.7754648903691366, 55.50929780738274]),
        ],
        expected_strings: &[("dataset", "legacy")],
    },
];
...
static SOREIDE_WHITSON_PHASE_CASES: &[TestCase] = &[
    ...
    TestCase {
        ...
        matrices: &[],
        expected: &[("z_factor", 0.7690830488152696)],
        expected_vectors: &[(
            "ln_phi",
            &[
                -0.344901510120477,
