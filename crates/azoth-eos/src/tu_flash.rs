//! `eos.tu_flash` - the pressure (or temperature) a mixture reaches at a given molar internal energy.
//!
...
use crate::results::TuFlashResult;

/// The pressure at which a mixture has a given molar internal energy.
///
/// # Errors
...
pub fn tu_flash(
    ...
    u: MolarEnergy,
    z: &[f64],
) -> Result<TuFlashResult> {
    let spec = &model_gen::TU_FLASH_SPEC;
