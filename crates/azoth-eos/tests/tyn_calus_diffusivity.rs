//! Spec-driven tests for `eos.tyn_calus_diffusivity`.
...
const CALC_ID: &str = "eos.tyn_calus_diffusivity";

fn call(case: &azoth_core::spec::TestCase) -> azoth_eos::TynCalusDiffusivityResult {
