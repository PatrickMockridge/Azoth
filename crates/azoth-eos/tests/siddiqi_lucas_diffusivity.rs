//! Spec-driven tests for `eos.siddiqi_lucas_diffusivity`.

use azoth_core::units::{cubic_meters_per_mole, kelvins, pascal_seconds};
use azoth_eos::{SiddiqiLucasForm, siddiqi_lucas_diffusivity, spec_gen};
use azoth_test_support as common;

const CALC_ID: &str = "eos.siddiqi_lucas_diffusivity";

fn call(case: &azoth_core::spec::TestCase) -> azoth_eos::SiddiqiLucasDiffusivityResult {
    let form: SiddiqiLucasForm = common::input_str(case, "form").parse().unwrap();
