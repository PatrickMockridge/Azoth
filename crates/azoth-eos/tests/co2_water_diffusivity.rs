//! Spec-driven tests for `eos.co2_water_diffusivity`.
...
const CALC_ID: &str = "eos.co2_water_diffusivity";

fn call(case: &azoth_core::spec::TestCase) -> azoth_eos::Co2WaterDiffusivityResult {
    co2_water_diffusivity(kelvins(common::input(case, "T")))
