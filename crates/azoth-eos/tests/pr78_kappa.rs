//! Spec-driven tests for `eos.pr78_kappa`.

use azoth_eos::pr78_kappa;
use azoth_eos::spec_gen;
use azoth_test_support as common;

const CALC_ID: &str = "eos.pr78_kappa";

fn call(case: &azoth_core::spec::TestCase) -> azoth_eos::Pr78KappaResult {
    pr78_kappa(common::input(case, "omega"))
