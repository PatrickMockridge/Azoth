//! Spec-driven tests for `eos.pr_danesh_alpha`.

use azoth_eos::pr_danesh_alpha;
use azoth_eos::spec_gen;
use azoth_test_support as common;

const CALC_ID: &str = "eos.pr_danesh_alpha";

fn call(case: &azoth_core::spec::TestCase) -> azoth_eos::PrDaneshAlphaResult {
    pr_danesh_alpha(common::input(case, "omega"), common::input(case, "Tr"))
