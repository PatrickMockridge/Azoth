//! Spec-driven tests for `eos.pr_gassem2001_alpha`.

use azoth_eos::pr_gassem2001_alpha;
use azoth_eos::spec_gen;
use azoth_test_support as common;

const CALC_ID: &str = "eos.pr_gassem2001_alpha";

fn call(case: &azoth_core::spec::TestCase) -> azoth_eos::PrGassem2001AlphaResult {
    pr_gassem2001_alpha(common::input(case, "omega"), common::input(case, "Tr"))
