//! Spec-driven tests for `eos.pr_lee_kesler_alpha`.

use azoth_eos::pr_lee_kesler_alpha;
use azoth_eos::spec_gen;
use azoth_test_support as common;

const CALC_ID: &str = "eos.pr_lee_kesler_alpha";

fn call(case: &azoth_core::spec::TestCase) -> azoth_eos::PrLeeKeslerAlphaResult {
    pr_lee_kesler_alpha(common::input(case, "omega"), common::input(case, "Tr"))
