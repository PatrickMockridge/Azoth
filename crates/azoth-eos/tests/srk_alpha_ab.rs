...
use azoth_eos::srk_alpha_ab;
use azoth_test_support as common;

const CALC_ID: &str = "eos.srk_alpha_ab";

fn call(case: &azoth_core::spec::TestCase) -> azoth_eos::SrkAlphaAbResult {
    srk_alpha_ab(
...
fn field(result: &azoth_eos::SrkAlphaAbResult, name: &str) -> f64 {
    match name {
        "alpha" => result.alpha,
