//! Spec-driven tests for `eos.srk_peneloux_shift`.
...
const CALC_ID: &str = "eos.srk_peneloux_shift";

fn call(case: &azoth_core::spec::TestCase) -> azoth_eos::SrkPenelouxShiftResult {
    srk_peneloux_shift(
