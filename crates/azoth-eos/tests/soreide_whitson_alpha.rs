//! Spec-driven tests for `eos.soreide_whitson_alpha`.

use azoth_eos::soreide_whitson_alpha;
use azoth_eos::spec_gen;
use azoth_test_support as common;

const CALC_ID: &str = "eos.soreide_whitson_alpha";

fn call(case: &azoth_core::spec::TestCase) -> azoth_eos::SoreideWhitsonAlphaResult {
    soreide_whitson_alpha(common::input(case, "salinity"), common::input(case, "Tr"))
            ...
            "worked_example" | "reference" => {
                ...
                common::assert_warnings_agree_with_spec(
                    ...
                    |quantity| match quantity {
                        "salinity" => Some(common::input(case, "salinity")),
