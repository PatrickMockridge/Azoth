//! Spec-driven tests for `eos.twucoon_alpha`.

use azoth_eos::spec_gen;
use azoth_eos::twucoon_alpha;
use azoth_test_support as common;

const CALC_ID: &str = "eos.twucoon_alpha";

fn call(case: &azoth_core::spec::TestCase) -> azoth_eos::TwucoonAlphaResult {
    twucoon_alpha(common::input(case, "omega"), common::input(case, "Tr"))
