//! Spec-driven tests for `eos.schwartzentruber_alpha`.

use azoth_eos::schwartzentruber_alpha;
use azoth_eos::spec_gen;
use azoth_test_support as common;

const CALC_ID: &str = "eos.schwartzentruber_alpha";

fn call(case: &azoth_core::spec::TestCase) -> azoth_eos::SchwartzentruberAlphaResult {
    schwartzentruber_alpha(
        common::input(case, "omega"),
        common::input(case, "p1"),
        common::input(case, "p2"),
        common::input(case, "p3"),
            ...
            "worked_example" | "reference" => {
                ...
                common::assert_warnings_agree_with_spec(
                    ...
                    |quantity| match quantity {
                        ...
                        "p1" => Some(common::input(case, "p1")),
                        "p2" => Some(common::input(case, "p2")),
                        "p3" => Some(common::input(case, "p3")),
