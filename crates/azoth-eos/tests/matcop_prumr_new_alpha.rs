//! Spec-driven tests for `eos.matcop_prumr_new_alpha`.

use azoth_eos::matcop_prumr_new_alpha;
use azoth_eos::spec_gen;
use azoth_test_support as common;

const CALC_ID: &str = "eos.matcop_prumr_new_alpha";

fn call(case: &azoth_core::spec::TestCase) -> azoth_eos::MatcopPrumrNewAlphaResult {
