//! Spec-driven tests for `eos.umrpr_alpha`.

use azoth_eos::spec_gen;
use azoth_eos::umrpr_alpha;
use azoth_test_support as common;

const CALC_ID: &str = "eos.umrpr_alpha";

fn call(case: &azoth_core::spec::TestCase) -> azoth_eos::UmrprAlphaResult {
    umrpr_alpha(common::input(case, "omega"), common::input(case, "Tr"))
