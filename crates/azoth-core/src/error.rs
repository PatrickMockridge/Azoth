...
impl AzothError {
    /// Construct an [`AzothError::InvalidInput`].
    ...
    /// Construct an [`AzothError::OutOfRange`].
...
mod tests {
    ...
    fn solver_error_reports_its_numbers() {
        let e = AzothError::SolverNotConverged {
            iterations: 100,
            residual: 1e-7,
            tolerance: 1e-12,
        };
