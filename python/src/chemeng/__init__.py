"""chemeng - open, validated, citable chemical engineering calculations.
...
>>> r = chemeng.hydraulics.reynolds_number(
...
from chemeng import core
from chemeng._dispatch import Backend, available, describe, extension, select, use_backend
...
from chemeng.core.units import Q, ureg
from chemeng.core.warnings import Warning, WarningCode

__version__ = "0.1.0"

# Imported last: `chemeng.hydraulics` pulls in the dispatch layer, which imports
# this package's submodules. Keeping it at the bottom means everything it needs
# is already bound.
from chemeng import hydraulics, properties
