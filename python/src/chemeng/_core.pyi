...
Nothing here is part of the public API. `chemeng.hydraulics` is, and it returns
the result dataclasses in `chemeng.core.result` rather than the transport types
below - see `chemeng._rust_bridge`.
"""
...
# Python, before the call crosses this boundary. See crates/chemeng-python.
...
# --- exceptions -----------------------------------------------------------
# Re-exported from chemeng.core.errors, so both backends raise the same class
