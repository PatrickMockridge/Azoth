...
from azoth.core.result import FurstElectrolyteMod2004PhaseResult
...
MODEL_ID = "eos.furst_electrolyte_mod2004_phase"
...
def furst_electrolyte_mod2004_phase(
    ...
    fluid, _ = furst_mixture_of(list(components), mod2004=True)
...
__all__ = ["furst_electrolyte_mod2004_phase"]
