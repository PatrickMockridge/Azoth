"""``eos.th_flash`` - the pressure a mixture reaches at a given property.
...
from azoth.core.result import ThFlashResult
...
def th_flash(
    ...
    apply_checks(checks.on_input, {"T": t_si, "H": h_si}.get, warnings)

    solved = solve_pressure(mixture, ideal_gas, t_si, h_si, list(z), "h", spec["algorithm"], 1.0e5)
