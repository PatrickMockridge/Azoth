"""``eos.ts_flash`` - the pressure a mixture reaches at a given property.
...
from azoth.core.result import TsFlashResult
...
def ts_flash(
    ...
    apply_checks(checks.on_input, {"T": t_si, "S": s_si}.get, warnings)

    solved = solve_pressure(mixture, ideal_gas, t_si, s_si, list(z), "s", spec["algorithm"], 1.0e5)
