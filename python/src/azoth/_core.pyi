...
@final
class Overlay:
    """A keycard's sections, as the extension reads them. Built entry by entry from the values `azoth.keycard` resolved to, never parsed from a file, and opaque: what it resolves to is read through `overlay_entry_row` and its siblings."""
