...
case**: 4,888 of the 14,333 subsets of the species the three tables' loaded reactions name
seed at least one component, which the Rust twin's sweep test asserts.
"""
