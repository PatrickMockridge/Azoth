...
class KeycardError(AzothError, ValueError):
    ...
    Python-only. `azoth.keycard` and `azoth_eos::card` read the same file and refuse
    the same documents, each with its own class; nothing raises this one from Rust.
    """
