"""Tests for the ``eos.tu_flash`` model.
...
from azoth.eos import IdealGasModel, Mixture, component, mixture, tu_flash
...
def test_spec_case(case: dict[str, Any]) -> None:
    result = tu_flash(**h.model_kwargs(SPEC, case["inputs"]))
...
def test_the_round_trip_inverts_the_property() -> None:
    ...
    result = tu_flash(fluid, ideal_gas, Q(300.0, "K"), Q(target, "J/mol"), z)
